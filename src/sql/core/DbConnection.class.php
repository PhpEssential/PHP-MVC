<?php
namespace phpessential\mvc\sql\core;
...
class DbConnection {
	...
	public static function getInstance(): DbConnection {
		if (self::$instance == null) {
			self::$instance = new DbConnection(Config::get(Config::DB_HOST), Config::get(Config::DB_USER), Config::get(Config::DB_PASSWORD), Config::get(Config::DB_NAME));
		}
