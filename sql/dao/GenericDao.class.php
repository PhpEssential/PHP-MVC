<?php
namespace framework\sql\dao;

use framework\Config;
use framework\sql\core\query\Fetcher;
use framework\sql\models\Entity;
use framework\sql\models\GenericEntity;
...
abstract class GenericDao {
     ...
     *
     * @param Entity $entity model à mettre à jour
     * @throws \Exception
     */
     ...
     *
     * @param Entity $entity model à supprimer
     * @throws \Exception
     */
    public function delete(Entity $entity) {
        $entity->delete($this->conn);
    }
     ...
     *
     * @param Fetcher $select requête à exécuter
     * @throws \Exception
     * @return array
     */
    ...
    public function findById(int $id) {
    	...
    	$fetcher
    		->findConditions()
    		->eq($fetcher->findField(GenericEntity::FIELD_ID), $id);
